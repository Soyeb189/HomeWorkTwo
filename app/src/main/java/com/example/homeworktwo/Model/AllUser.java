...
public class AllUser implements Serializable, Parcelable
{
    ...
    public final static Parcelable.Creator<AllUser> CREATOR = new Creator<AllUser>() {


        @SuppressWarnings({
                "unchecked"
        })
        public AllUser createFromParcel(Parcel in) {
            return new AllUser(in);
        }
        ...
        public AllUser[] newArray(int size) {
            ...
            ;
    private final static long serialVersionUID = -3348892075436724723L;

    protected AllUser(Parcel in) {
